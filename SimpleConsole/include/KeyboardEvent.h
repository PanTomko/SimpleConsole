...
namespace sc
{
	enum class DllExport ControlKey {
		Null = 0x0000,
	...
	/*
	 * Holds information of sigle keyboard event np. someone pressed a button X.
	 */
	class DllExport KeyboardEvent {
	public:
		Key key;
